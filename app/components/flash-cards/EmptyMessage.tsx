...
export default function EmptyMessage({ groupName }: { groupName: string }) {
  return (
    <section className='max-w-3xl mx-auto px-4'>
      <div className='flex flex-col items-center bg-white p-4 my-16 shadow-md h-80 justify-center'>
        <h2 className='text-3xl font-semibold text-teal-900 text-center'>
